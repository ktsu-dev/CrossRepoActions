...
- Fix ktsu.Sdk 2.27 analyzer error KTSU0007: Polyfill PrivateAssets [patch] ([@matt-edmondson](https://github.com/matt-edmondson))
...
- Bump NuGet.Versioning from 7.6.0 to 7.9.0 ([@dependabot[bot]](https://github.com/dependabot[bot]))
...
- [minor] Replace the PowerShell SDK host with ktsu.RunCommand ([@matt-edmondson](https://github.com/matt-edmondson))
- [patch] Store icon.png through the Git LFS clean filter ([@matt-edmondson](https://github.com/matt-edmondson))
- chore: update ktsu.Sdk to 2.21.1 [patch] ([@matt-edmondson](https://github.com/matt-edmondson))
- Sync global.json ([@KtsuTools](https://github.com/KtsuTools))
- [patch] Fix restore failures from duplicate and vulnerable package versions ([@matt-edmondson](https://github.com/matt-edmondson))
...
- feat: skip untracked repos and background commit actions ([@matt-edmondson](https://github.com/matt-edmondson))
- feat: send only whole-file diffs when truncated; print diff inline for [D]iff ([@matt-edmondson](https://github.com/matt-edmondson))
- docs: document Semantic Kernel LLM integration and SuggestCommits/ConfigureLlm verbs ([@matt-edmondson](https://github.com/matt-edmondson))
- fix: report rejected pushes and apply review polish ([@matt-edmondson](https://github.com/matt-edmondson))
- feat: add SuggestCommits verb for AI commit messages ([@matt-edmondson](https://github.com/matt-edmondson))
- feat: add ConfigureLlm verb for OpenAI settings ([@matt-edmondson](https://github.com/matt-edmondson))
- feat: add diff, stage-all, and difftool git helpers ([@matt-edmondson](https://github.com/matt-edmondson))
- feat: add Semantic Kernel OpenAI chat completion service ([@matt-edmondson](https://github.com/matt-edmondson))
- feat: add commit message generator and LLM service interface ([@matt-edmondson](https://github.com/matt-edmondson))
- feat: add Semantic Kernel packages and LLM settings ([@matt-edmondson](https://github.com/matt-edmondson))
- test: add test project with InternalsVisibleTo ([@matt-edmondson](https://github.com/matt-edmondson))
- docs: add implementation plan and set default model to gpt-5.4-mini ([@matt-edmondson](https://github.com/matt-edmondson))
- docs: add per-phase progress counters to commit-message design ([@matt-edmondson](https://github.com/matt-edmondson))
- docs: add design for Semantic Kernel LLM integration and AI commit messages ([@matt-edmondson](https://github.com/matt-edmondson))
...
- [minor] Add GitFetch and InstallGitLfs verbs ([@matt-edmondson](https://github.com/matt-edmondson))
...
Changes since v1.2.55:

- Bump the ktsu group with 3 updates ([@dependabot[bot]](https://github.com/dependabot[bot]))

## v1.2.55 (patch)

Changes since v1.2.54:
...
Changes since v1.2.51:

- Bump the ktsu group with 1 update ([@dependabot[bot]](https://github.com/dependabot[bot]))

## v1.2.51 (patch)

Changes since v1.2.50:

- Bump the ktsu group with 2 updates ([@dependabot[bot]](https://github.com/dependabot[bot]))

## v1.2.50 (patch)

Changes since v1.2.49:

- Bump the ktsu group with 2 updates ([@dependabot[bot]](https://github.com/dependabot[bot]))

## v1.2.49 (patch)

Changes since v1.2.48:
...
- Bump NuGet.Versioning from 7.3.1 to 7.6.0 ([@dependabot[bot]](https://github.com/dependabot[bot]))
...
- Sync .github\workflows\dotnet.yml ([@ktsu[bot]](https://github.com/ktsu[bot]))
- Sync global.json ([@ktsu[bot]](https://github.com/ktsu[bot]))
- Bump NuGet.Versioning from 7.0.1 to 7.3.0 ([@dependabot[bot]](https://github.com/dependabot[bot]))
- Bump the microsoft group with 2 updates ([@dependabot[bot]](https://github.com/dependabot[bot]))
- Bump the ktsu group with 1 update ([@dependabot[bot]](https://github.com/dependabot[bot]))
- Merge remote-tracking branch 'refs/remotes/origin/main' ([@ktsu[bot]](https://github.com/ktsu[bot]))
...
## v1.2.9-pre.7 (prerelease)

Changes since v1.2.9-pre.6:

- Bump NuGet.Versioning from 7.0.1 to 7.3.0 ([@dependabot[bot]](https://github.com/dependabot[bot]))
- Bump the microsoft group with 2 updates ([@dependabot[bot]](https://github.com/dependabot[bot]))

## v1.2.9-pre.6 (prerelease)

Changes since v1.2.9-pre.5:
...
## v1.2.8-pre.3 (prerelease)

Changes since v1.2.8-pre.2:
...
- Bump Polyfill from 9.7.3 to 9.7.6 ([@dependabot[bot]](https://github.com/dependabot[bot]))
- Bump the microsoft group with 2 updates ([@dependabot[bot]](https://github.com/dependabot[bot]))
- Bump the ktsu group with 1 update ([@dependabot[bot]](https://github.com/dependabot[bot]))
...
## v1.2.3-pre.21 (prerelease)

Changes since v1.2.3-pre.20:

- Bump the ktsu group with 1 update ([@dependabot[bot]](https://github.com/dependabot[bot]))

## v1.2.3-pre.20 (prerelease)

Changes since v1.2.3-pre.19:

- Update: - ktsu.AppDataStorage to 1.15.6 - ktsu.Extensions to 1.5.6 ([@dependabot[bot]](https://github.com/dependabot[bot]))

## v1.2.3-pre.19 (prerelease)

Changes since v1.2.3-pre.18:

- Update ktsu.AppDataStorage package version to 1.15.5 ([@matt-edmondson](https://github.com/matt-edmondson))

## v1.2.3-pre.18 (prerelease)

Changes since v1.2.3-pre.17:
...
- Update: - ktsu.AppDataStorage to 1.15.4 - ktsu.Extensions to 1.5.5 ([@dependabot[bot]](https://github.com/dependabot[bot]))
...
- Update NuGet.Versioning to 6.14.0 ([@dependabot[bot]](https://github.com/dependabot[bot]))
...
- Update ktsu.AppDataStorage package version to 1.1.41 ([@matt-edmondson](https://github.com/matt-edmondson))
